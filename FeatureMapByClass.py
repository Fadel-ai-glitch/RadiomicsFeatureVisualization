...
#     features_class_list = ['glcm']
    
#     img_path = '/home/kpegouni/Documents/AI-projects/radiomics/data/interim/ICM-DATA/PELVIS/T2WI/volumes/sub-0400554.nii.gz'
...
#     store_path ='/home/kpegouni/Documents/AI-projects/radiomics/RadiomicsFeatureVisualization/ICM-DATA/FeatureMap/T2WI/'
...
#     cropped_img_path = store_path / 'original_cropped_img.nii.gz'
#     cropped_roi_path = store_path / 'original_cropped_roi.nii.gz'
#     feature_name = 'original_glszm_SizeZoneNonUniformityNormalized'
#     feature_map = store_path / str(feature_name+'.nrrd')
#     fig_save_path = store_path / 'figures' / feature_name
...
#     feature_mapper = FeatureMapper()
#     features_name_list = ['original_glcm_DifferenceEntropy', 'original_glcm_JointEntropy']
#     features_class_list = ['glcm'] # This variable is defined but not used.

#     img_path = '/home/kpegouni/Documents/AI-projects/radiomics/data/interim/ICM-DATA/PELVIS/T2WI/volumes/sub-0400554.nii.gz'
#     roi_path = '/home/kpegouni/Documents/AI-projects/radiomics/data/interim/ICM-DATA/PELVIS/T2WI/segmentations/sub-0400554_mask.nii.gz'

#     # Fix: Convert store_path to a Path object here
#     store_path = Path('/home/kpegouni/Documents/AI-projects/radiomics/RadiomicsFeatureVisualization/ICM-DATA/FeatureMap/T2WI/')

#     if not store_path.exists(): # Use Path.exists()
#         store_path.mkdir(parents=True, exist_ok=True) # Use Path.mkdir() with parents and exist_ok

#     feature_mapper.generate_feature_map(str(img_path), str(roi_path), 1, features_name_list, str(store_path))

#     # Now, store_path is a Path object, so you can use the / operator
#     cropped_img_path = store_path / 'original_cropped_img.nii.gz'
#     cropped_roi_path = store_path / 'original_cropped_roi.nii.gz'
#     feature_name = 'original_glcm_JointEntropy' # Changed to a feature generated by the script
#     feature_map = store_path / (feature_name + '.nrrd') # Correct concatenation
#     fig_save_path = store_path / 'figures' / feature_name

#     # Ensure the 'figures' directory exists before trying to save there
#     if not (store_path / 'figures').exists():
#         (store_path / 'figures').mkdir(parents=True, exist_ok=True)
...
# ... (imports et classes FeatureMapper et FeatureMapVisualizition)
...
def main():
    ...
    patient_id_to_process = '2304155' # Remplacez par l'ID du patient actuel
